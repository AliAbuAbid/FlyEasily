...
class passengers(models.Model):
    ...
    fn = models.CharField(max_length=50, null=False)
    job = models.CharField(max_length=40, null=False)
    ...
    age = models.DateField(null=False,default="2004-01-01")
...
class Passengerorders(models.Model):
